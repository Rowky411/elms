 <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="contentUpload.php"
          aria-expanded="true" > Content Upload 
        </a>
      </li>

      <li class="nav-item">
        <a class="nav-link collapsed" href="setAppointment.php"
          aria-expanded="true" > Set Counseling time  
        </a>
      </li>

      <li class="nav-item">
        <a class="nav-link collapsed" href="approveCounseling.php"
          aria-expanded="true" > Counseling Requests  
        </a>
      </li>

      <li class="nav-item">
        <a class="nav-link collapsed" href="makeAnnouncement.php"
          aria-expanded="true" > Announcement   
        </a>
      </li>
      <hr class="sidebar-divider">
    </ul>