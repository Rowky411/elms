                ...
                <div class="card-body">
                  <form method="post">
                    <div class="form-group row mb-3">
                        <div class="col-xl-6">
                            <label class="form-control-label">Announcement<span class="text-danger ml-2">*</span></label>
                      <textarea cols="30" rows="10" class="form-control" name="className" value="<?php echo $row['className'];?>" id="exampleInputFirstName" placeholder="Write Something..."></textarea>
                        </div>
                    </div>
                      <?php
                    if (isset($Id))
